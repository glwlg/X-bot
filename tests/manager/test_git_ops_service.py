...
from manager.dev.git_ops_service import GitOpsService
...
async def test_git_ops_push_falls_back_to_fork(monkeypatch):
    ...
    monkeypatch.setattr(
        "manager.dev.git_ops_service.workspace_session_service.inspect",
        fake_inspect,
    )
    monkeypatch.setattr("manager.dev.git_ops_service.run_shell", fake_run_shell)
