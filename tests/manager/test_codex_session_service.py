...
from manager.dev.codex_session_service import CodexSessionService
...
async def test_codex_session_start_waits_for_user_when_backend_asks(
    ...
    monkeypatch.setattr(
        "manager.dev.codex_session_service.run_coding_backend",
...
async def test_codex_session_continue_injects_question_and_user_reply(
    ...
    monkeypatch.setattr("manager.dev.codex_session_service.run_shell", fake_run_shell)
    monkeypatch.setattr(
        "manager.dev.codex_session_service.run_coding_backend",
        fake_run_coding_backend,
    )
